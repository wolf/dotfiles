...
export OBSIDIAN_INBOX_DIR="${OBSIDIAN_VAULTS_DIR}/Notes/0-inbox"

# This is for typing directory names at the prompt, therefore, this topic only needs to be sourced for,
# interactive shells.
export CDPATH=.:"${WOLF_REPOS_DIR}":"${DMP_REPOS_DIR}":"${REPOS_DIR}":"${OBSIDIAN_INBOX_DIR}":"${PROJECTS_DIR}":"${DROPBOX_DIR}"
